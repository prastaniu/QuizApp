CREATE DATABASE  IF NOT EXISTS `quiz_app` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `quiz_app`;
...
CREATE TABLE `question_answers` (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `question_answers_quiz_attempt_id_index` (`quiz_attempt_id`),
  KEY `question_answers_question_id_index` (`question_id`),
  KEY `question_answers_selected_option_id_index` (`selected_option_id`),
  CONSTRAINT `question_answers_question_id_foreign` FOREIGN KEY (`question_id`) REFERENCES `questions` (`id`) ON DELETE CASCADE,
  CONSTRAINT `question_answers_quiz_attempt_id_foreign` FOREIGN KEY (`quiz_attempt_id`) REFERENCES `quiz_attempts` (`id`) ON DELETE CASCADE,
  CONSTRAINT `question_answers_selected_option_id_foreign` FOREIGN KEY (`selected_option_id`) REFERENCES `question_options` (`id`) ON DELETE SET NULL
...
CREATE TABLE `question_options` (
  ...
  KEY `question_options_order_index` (`order`),
...
CREATE TABLE `questions` (
  ...
  `question_type` enum('multiple_choice','true_false') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'multiple_choice',
...
CREATE TABLE `quiz_attempts` (
  ...
  KEY `quiz_attempts_student_id_index` (`student_id`),
  KEY `quiz_attempts_is_submitted_index` (`is_submitted`),
  CONSTRAINT `quiz_attempts_quiz_id_foreign` FOREIGN KEY (`quiz_id`) REFERENCES `quizzes` (`id`) ON DELETE CASCADE,
  CONSTRAINT `quiz_attempts_student_id_foreign` FOREIGN KEY (`student_id`) REFERENCES `students` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2026-03-31 19:12:04
